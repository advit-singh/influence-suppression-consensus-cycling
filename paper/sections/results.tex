...
The global distribution across all 368,991 runs partitions into four distinct stability outcomes\cite{acemoglu2013opinion}:

Regime 1B (Fixed Dissensus): 273,024 runs (73.99%)\cite{acemoglu2013opinion}.

Regime 1 (Biased Convergence): 86,808 runs (23.53%)\cite{acemoglu2013opinion}.

Regime 2 (Slow Mixing): 7,454 runs (2.02%)\cite{acemoglu2013opinion}.
...
\subsection{Ablation Analysis and Coercive Homogenization}
...
The symmetric penalty model produces a marked shift in the stability distribution\cite{acemoglu2013opinion}. It enters Regime 3 cycling at a rate of 0.54%, which is 27 times higher than the proposed directional model's rate of 0.02%\cite{acemoglu2013opinion}. In addition, symmetric penalization increases the incidence of Regime 2 slow mixing to 4.18% (compared to 1.67% in the proposed model)\cite{acemoglu2013opinion}.
...
However, this elevated instability is accompanied by tighter consensus accuracy\cite{degroot1974reaching}. The symmetric penalty yields a mean consensus error of $0.0257 \pm 0.0319$, compared to $0.0924 \pm 0.0852$ for the proposed directional model\cite{acemoglu2013opinion}. Penalizing both tails acts as a coercive leveling clamp: by penalizing both positive and negative deviance, it compresses opinions into a narrow band, minimizing error relative to the initial ground truth $\mu^*$, but at the cost of higher network fragmentation and limit-cycle susceptibility\cite{degroot1974reaching,acemoglu2013opinion}.
...
\input{sections/cross_model_table}
Model / Baseline
